...
int main() {
    ...
    if (choice1 == "d") { // DOS DOCUMENTOS
        ...
        string text_definitivo1 = normalizeText(text1); //normalizetext se eliminan espacios, signos de puntuacion, se pasa a minusculas
        string text_definitivo2 = normalizeText(text2);
        // Generar k-shingles
        ...
        try {
            ...
            for (int i = 0; i < documentos.size(); ++i) {
                string textoNormalizado = normalizeText(documentos[i]); // Normalizar documento
